...
public class LoginPageTest extends BaseTest {
	...
	@Test(priority=1,description = "TC_003_Validate if Forgot password link is present on Login Page")
	...
	@Test(priority=2,description = "TC_002_Validate Login Page with Invalid credentials")
